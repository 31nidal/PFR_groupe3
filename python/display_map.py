#!/usr/bin/env python3
"""
lidar_map.py — Cartographie LiDAR propre
Version corrigée :
- suppression des grosses déformations OpenCV
- murs plus réalistes
- obstacles mieux séparés
- conservation de la géométrie réelle

Usage :
python3 lidar_scan.py | python3 lidar_map.py
"""
...
# MORPHOLOGIE (beaucoup plus légère)
WALL_DILATION = 3
WALL_CLOSE    = 4
WALL_MIN_AREA = 200
...
print("Carte sauvegardée : /tmp/lidar_map.png", file=sys.stderr)
